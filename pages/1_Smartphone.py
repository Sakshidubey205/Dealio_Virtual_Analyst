...
with col2:
    if st.button(" Rating Prediction"):
        st.switch_page("pages/3_Rating_Prediction.py")

with col3:
    if st.button("Price Prediction"):
        st.switch_page("pages/4_Price_Prediction.py")

with col4:
    if st.button("Dashboard of the Smartphone Market"):
        st.switch_page("pages/5_dashboard_smartphones.py")
...
if st.button("Generate Full EDA Report"):
    ...
    file_path = "eda_report_smartphones.html"
